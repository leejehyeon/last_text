...
?>
		...
		?>
        	...
        	<input type="hidden" id="year" name="year" value="<?echo $this -> uri -> segment(3); ?>" />
        	<input type="hidden" id="month" name="month" value="<?echo $this -> uri -> segment(4); ?>" />
        	<div class="daily_journal_update_button_area">
            <input class="small_gray_button2" type="button" onclick="history.back()" value="취소"><input class="small_blue_button" type="button" value="수정" onclick="daily_form();"><input class="small_dark_button" type="button" value="삭제" onclick="history.back()">
            </div>
</form>
</div>
</div>