	...
	<div align="center" class = "row" id="tblMain">
		<table width="50%" cellpadding="0" cellspacing="0" style="text-align:center;" class="tutee_application_table">
			...
			<tr >
				...
				<td colspan=5 ><input type="text" name="user_content_application" id="user_content_application" value="<?echo $user_data['user_content_application'];?>" style="height:100%; width:100%;"></td>
			</tr>
		</table>
	</div>
